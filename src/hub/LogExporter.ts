...
export default class LogExporter {
  ...
  static async generateBin(
    ...
    switch (options.format) {
      case "csv-table":
        return LogExporter.generateCsvTable(log, fields, timestamps, progress);
      case "csv-list":
        return LogExporter.generateCsvList(log, fields, timestamps, progress);
      case "wpilog":
